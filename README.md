# Fraud detection using a carclaims dataset
...
- Feature engineering to improve model performance and the precision-recall-tradeoff
- Use docker to containerize the repository